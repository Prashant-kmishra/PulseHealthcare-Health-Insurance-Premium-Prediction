...
try:
    ...
    if not show_dashboard and not show_accuracy:
        ...
        <div class="accuracy-box">
            <h3 style="color:#2563eb !important; margin-top:0;">Ensemble Stacking Regressor</h3>
            <p style="font-size: 1.1rem; line-height: 1.7;">
                Instead of relying on a single algorithm, Pulse AI uses a powerful technique called <strong>Stacking</strong>. 
                We trained three distinct state-of-the-art models. Each model learns different complex patterns from our health data. 
                A final "Meta-Model" then learns how to optimally combine their predictions to produce the most accurate and reliable premium estimate possible.
            </p>
        </div>
        """, unsafe_allow_html=True)
        ...
        with c1:
            ...
            # Architecture Diagram using Plotly Sankey or simple flowchart
        ...
        with c2:
            st.markdown("<br><h4 style='color: #0f172a !important;'>Performance Metrics (CV MAE)</h4>", unsafe_allow_html=True)
            # Bar chart comparing errors
            fig_perf = go.Figure(go.Bar(
                x=['LightGBM', 'Random Forest', 'XGBoost', 'Stacked Meta-Model'],
                y=[781, 780, 776, 772],
                marker_color=['#94a3b8', '#94a3b8', '#94a3b8', '#3b82f6'],
                text=['781.0', '779.9', '776.2', '771.8'],
                textposition='auto',
            ))
